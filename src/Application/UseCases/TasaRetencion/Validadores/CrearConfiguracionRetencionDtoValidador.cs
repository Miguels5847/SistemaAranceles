...
public sealed class CrearConfiguracionRetencionDtoValidador : AbstractValidator<CrearConfiguracionRetencionDto>
{
    public CrearConfiguracionRetencionDtoValidador()
    {
