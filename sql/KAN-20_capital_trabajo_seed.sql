-- KAN-20_capital_trabajo_seed.sql
-- Variante KAN-20: copia de KAN14_fase5_lote02_capital_trabajo_seed.sql
-- Propósito: seed de datos maestros para "Capital de Trabajo" (15 cargos + 16 items)
-- Autor: Equipo SistemaAranceles
-- Fecha: 2026-05-04
-- Nota: idempotente (usa ON CONFLICT DO NOTHING). Ejecutar en schema `public`.
...
-- ============================================================================
-- Validación final (contar registros cargados)
-- ============================================================================
